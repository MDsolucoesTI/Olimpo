...
// M�dulo............: Cadastro e Manuten��o de Fornecedores
...
uses
  ...
  LMDCustomParentPanel, LMDBackPanel, EMsgDlg;
  ...
  If (dbCBoxTipo.Text='Pessoa F�sica') Then
    ...
    If dbeCpf.Text<>'           ' Then
      ...
      If not VerCpf1.valid Then
        MsgDlg.MsgWarning('CPF inv�lido');
  ...
  Else
    ...
    If dbeCNPJ.Text<>'              ' Then
      ...
      If not VerCnpj1.valid Then
        MsgDlg.MsgWarning('CNPJ inv�lido');
  ...
  if dmdados.tbFornecedor.RecordCount=0 then
    ...
    If MsgDlg.MsgConfirmation('Tem certeza que deseja excluir este registro?') = id_yes then
      ...
      if dmDados.tbCPagar.Locate('CodFor',dmDados.tbFornecedorCodFor.Value,[]) Then
        Flag:=True;
      if Flag Then
        MsgDlg.MsgWarning('Fornecedor ativo, ou com registro de opera��es anteriores.'+#13+#13+'N�o pode ser EXCLUI�DO!!!')
      else
...
begin
  If NovoItem Then
    If dbCBoxTipo.Text= '' then
      Begin
      MsgDlg.MsgError('� obrigat�rio informar o TIPO DE PESSOA');
      dbCBoxTipo.SetFocus;
      End
    Else
      Begin
      ...
      If Flag Then
        Begin
        MsgDlg.MsgWarning('Valor do TIPO DE PESSOA inv�lido');
        dbCBoxTipo.SetFocus;
        End;
      End;
end;
...
begin
  If NovoItem Then
    If dbfantasia.Text= '' then
      Begin
      Msgdlg.MsgError('� obrigat�rio o NOME FANTASIA');
      dbfantasia.SetFocus;
      End
end;
...
begin
  If NovoItem Then
    If dbRaz.Text= '' then
      Begin
      MsgDlg.MsgError('� obrigat�rio o NOME OU RAZ�O SOCIAL');
      dbRaz.SetFocus;
      End
end;
...
begin
  ...
  If NovoItem Then
    If dbecnpj.Text = '              ' Then
      Begin
      MsgDlg.MsgError('� necess�rio Informar o CNPJ');
      dbecnpj.setfocus;
      end
    Else
      Begin
...
begin
  ...
  If NovoItem Then
    If dbeCPF.Text = '           ' Then
      Begin
      MsgDlg.MsgError('� necess�rio Informar o CPF');
      dbeCPF.setfocus;
      end
    else
      Begin
...
begin
  If NovoItem Then
    If DBEend.Text= '' then
      Begin
      MsgDlg.MsgError('� obrigat�rio o Endere�o');
      DBEend.SetFocus;
      End
end;
...
begin
  If NovoItem Then
    If DBEnum.Text= '00000' then
      Begin
      MsgDlg.MsgError('� obrigat�rio o N�mero');
      DBEnum.SetFocus;
      End
end;
...
begin
  If NovoItem Then
    If DBEbairro.Text= '' then
      Begin
      MsgDlg.MsgError('� obrigat�rio o Bairro');
      DBEbairro.SetFocus;
      End
end;
...
begin
  If NovoItem Then
    If DBEcidade.Text= '' then
      Begin
      MsgDlg.MsgError('� obrigat�rio a Cidade');
      DBEcidade.SetFocus;
      End
end;
...
begin
  If NovoItem Then
    If DBCBoxUF.Text= '' then
      Begin
      MsgDlg.MsgError('� obrigat�rio informar ESTADO');
      DBCBoxUF.SetFocus;
      End
    Else
      Begin
      ...
      If Flag Then
        Begin
        MsgDlg.MsgWarning('ESTADO inv�lido');
        DBCboxUF.SetFocus;
        End
      End;
...
procedure TFrmCadFornec.btnEMailClick(Sender: TObject);
var
 url : string;
begin
