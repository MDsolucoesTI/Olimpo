...
var
  FrmRelBoletoBBV: TFrmRelBoletoBBV;
...
procedure TFrmRelBoletoBBV.BtnimprimirClick(Sender: TObject);
begin
...
procedure TFrmRelBoletoBBV.edClienteExit(Sender: TObject);
begin
if dmdados.TbCliente.Locate('nome',edCliente.Text,[]) then
   edit1.Text:=dmdados.TbClientecodcli.AsString;
end;

procedure TFrmRelBoletoBBV.BtnSairClick(Sender: TObject);
begin
 close;
end;

procedure TFrmRelBoletoBBV.cmbDestinoExit(Sender: TObject);
Var
  x:integer;
  Flag:Boolean;
begin
...
procedure TFrmRelBoletoBBV.edCcustoExit(Sender: TObject);
begin
if dmdados.TbCcusto.Locate('Descricao',edCcusto.Text,[]) then
   edit2.Text:=dmdados.TbCcustoCodCcusto.AsString;
end;

procedure TFrmRelBoletoBBV.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TFrmRelBoletoBBV.cmbClassifChange(Sender: TObject);
begin
If cmbClassif.Text= 'Por Cliente' Then
   Begin
...
procedure TFrmRelBoletoBBV.cmbDestinoChange(Sender: TObject);
Var
  x:integer;
  Flag:Boolean;
begin
...
procedure TFrmRelBoletoBBV.cmbDestinoCloseUp(Sender: TObject);
Var
  x:integer;
  Flag:Boolean;
begin
...
procedure TFrmRelBoletoBBV.DCComboExit(Sender: TObject);
Var
  x:integer;
  Flag:Boolean;
begin
...
procedure TFrmRelBoletoBBV.EdtInicialExit(Sender: TObject);
begin
...
procedure TFrmRelBoletoBBV.EdtFinalExit(Sender: TObject);
begin
...
procedure TFrmRelBoletoBBV.FormShow(Sender: TObject);
begin
FrmPrincipal.StatusTeclas(True,'[F2] Imprimir [Esc] Cancelar ou Sair');
    CmbDestino.Enabled:=false;
end;

procedure TFrmRelBoletoBBV.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmRelBoletoBBV.FormClose(Sender: TObject;
