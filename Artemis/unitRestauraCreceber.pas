...
procedure TFrmRestCR.BtnSairClick(Sender: TObject);
begin
Close;
end;

procedure TFrmRestCR.btnBuscarClick(Sender: TObject);
var
  Campos:String;
...
procedure TFrmRestCR.edcodigoExit(Sender: TObject);
begin
if rest then
begin
   if edcodigo.Text='' then
...
procedure TFrmRestCR.edDocExit(Sender: TObject);
begin
if rest then
begin
 if edDoc.Text='' then
...
procedure TFrmRestCR.FormClose(Sender: TObject;
...
procedure TFrmRestCR.btLocClienteClick(Sender: TObject);
begin
...
procedure TFrmRestCR.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
If Key=#13 Then
      Begin
...
procedure TFrmRestCR.FormShow(Sender: TObject);
begin
...
procedure TFrmRestCR.btnRestaurarClick(Sender: TObject);
var
  custo : string;
  ano,mes,dia : word;
...
procedure TFrmRestCR.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmRestCR.edContaExit(Sender: TObject);
begin
