...
type
  Tdmdados = class(TDataModule)
    ...
    tbChequeProlkNomeFor: TStringField;
    tbChequeProNumBanco: TStringField;
    tbChequeProNomeBanco: TStringField;
    tbChequeProNumCheque: TFloatField;
    tbChequeProAgencia: TStringField;
    tbChequeProValor: TCurrencyField;
    tbChequeProVencimento: TDateField;
    tbChequeProDataVen: TDateField;
    tbChequeProCodVen: TIntegerField;
    ...
    tbChequeProPre: TStringField;
    dsChequePro: TDataSource;
    tbCPagarPortador: TStringField;
    tbCPagarNumBanco: TStringField;
    tbCaixaDinAbre: TCurrencyField;
    tbCaixaCheAbre: TCurrencyField;
    tbCaixaDinEnt: TCurrencyField;
    tbCaixaCheVis: TCurrencyField;
    tbCaixaCartEnt: TCurrencyField;
    tbCaixaPagam: TCurrencyField;
    tbCaixaVales: TCurrencyField;
    tbCaixaSaiDiv: TCurrencyField;
    tbCaixaDinFecha: TCurrencyField;
    tbCaixaCheFecha: TCurrencyField;
    tbCaixaCartFecha: TCurrencyField;
    tbCaixaTotAbre: TCurrencyField;
    tbCaixaTotVis: TCurrencyField;
    tbCaixaTotPra: TCurrencyField;
    tbCaixaTotSai: TCurrencyField;
    tbCaixaTotFecha: TCurrencyField;
    tbCaixaChePra: TCurrencyField;
    tbCaixaStatus: TStringField;
    tbCReceberAtraso: TFloatField;
    tbCRecSele: TTable;
    ...
    procedure tbCReceberCalcFields(DataSet: TDataSet);
  private
...
begin
  tbCaixaTotAbre.Value:=tbCaixaDinAbre.Value+tbCaixaCheAbre.Value;
  tbCaixaTotVis.Value:=tbCaixaDinEnt.Value+tbCaixaCheVis.Value;
  tbCaixaTotPra.Value:=tbCaixaChePra.Value+tbCaixaCartEnt.Value;
  tbCaixaTotSai.Value:=tbCaixaPagam.Value+tbCaixaVales.Value+tbCaixaSaiDiv.Value;
  tbCaixaTotFecha.Value:=tbCaixaDinFecha.Value+tbCaixaCartFecha.Value+tbCaixaCheFecha.Value;
end;

procedure Tdmdados.tbCReceberCalcFields(DataSet: TDataSet);
begin
  if Date > tbCReceberDataVenc.Value then
    tbCReceberAtraso.Value:=(Date-tbCReceberDataVenc.Value)
  else
    tbCReceberAtraso.Value:=0;
end;
