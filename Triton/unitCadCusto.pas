...
procedure TFrmCCusto.DBEDescrEnter(Sender: TObject);
begin
(Sender as TDbEdit).Color:=clTeal;
end;

procedure TFrmCCusto.DBEDescrExit(Sender: TObject);
begin
(Sender as TDbEdit).Color:=clWindow;
end;

procedure TFrmCCusto.BtnLocalizarClick(Sender: TObject);
begin
{FrmLocCCusto:=TFrmLocCCusto.Create(Application);
FrmLocCCusto.showmodal;}
end;

procedure TFrmCCusto.BtnLocalizarClick0(Sender: TObject);
begin
{FrmLocCCusto:=TFrmLocCCusto.Create(Application);
FrmLocCCusto.ShowModal;}
end;
...
procedure TFrmCCusto.DBEBancoEnter(Sender: TObject);
begin
(Sender as TDbEdit).Color:=$00D2E2FF;
If ((DmDados.tbCCusto.State<>dsInsert) And Not(Mudar)) Then
