...
procedure TfrmCadHist.BtnSairClick(Sender: TObject);
begin
     Close;
end;


procedure TfrmCadHist.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
Action:= Cafree;
end;

procedure TfrmCadHist.FormKeyPress(Sender: TObject; var Key: Char);
begin
If Key=#13 Then
      Begin
      Key:=#0;
...
procedure TfrmCadHist.DBEdescEnter(Sender: TObject);
begin
...
procedure TfrmCadHist.DBEdescExit(Sender: TObject);
Var
Tabela: TTable;
begin
...
procedure TfrmCadHist.BtnAlterarClick(Sender: TObject);
begin
novoitem:=true;
...
procedure TfrmCadHist.BtnDeletarClick(Sender: TObject);
var
   flag:boolean;
begin
NovoItem:=False;
...
procedure TfrmCadHist.fclGravarClick(Sender: TObject);
var
	Tabela: TTable;
  Gravar:Boolean;
begin
...
procedure TfrmCadHist.FormShow(Sender: TObject);
begin
Mudar:=False;
...
procedure TfrmCadHist.BtnCancelarClick(Sender: TObject);
begin
dmdados.tbHistorico.cancel;
NovoItem:= False;
//dmdados.vTabStt:=true;
...
procedure TfrmCadHist.BtnNovoClick(Sender: TObject);
begin
dmdados.tbHistorico.cancel;
NovoItem:= True;
//dmdados.vTabStt:=false;
...
procedure TfrmCadHist.BtnPrimeiroClick(Sender: TObject);
begin
...
procedure TfrmCadHist.BtnAnteriorClick(Sender: TObject);
begin
...
procedure TfrmCadHist.BtnProximoClick(Sender: TObject);
begin
...
procedure TfrmCadHist.BtnUltimoClick(Sender: TObject);
begin
...
procedure TfrmCadHist.DBEcodEnter(Sender: TObject);
begin
(Sender as TDbEdit).Color:=$00D2E2FF;
end;

procedure TfrmCadHist.DBEcodExit(Sender: TObject);
begin
(Sender as TDbEdit).Color:=clWindow;
end;

procedure TfrmCadHist.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
